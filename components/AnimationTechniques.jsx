...
const AnimationTechniques = ({ onComplete, onBack }) => {
  ...
  const pages = [
    "🎬 Animation involves different techniques and structured workflows to create smooth, engaging motion.",
  ...
  const quizQuestions = [
    {
      question: "Which animation technique involves tracing real-life footage to create realistic animations?",
      options: [
    ...
    {
      question: "Which animation method uses algorithms or artificial intelligence to generate motion dynamically?",
      options: ["Frame-by-Frame Animation", "3D Animation & Motion Capture", "Tweening", "Procedural & AI-Based Animation"],
      correctAnswer: "Procedural & AI-Based Animation"
    }
  ];
